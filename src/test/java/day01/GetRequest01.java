...
public class GetRequest01 {
    ...
    public void test01(){
        ...
        //response.peek();         ==> response'u String olarak yazdirir
        ...
        Assert.assertEquals("Status Line Hatali","HTTP/1.1 200 OK",response.getStatusLine());
        Assert.assertEquals("Status Kod Hatali","application/json; charset=utf-8",response.getContentType());
